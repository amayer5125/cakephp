...
class Cookie implements CookieInterface
{
    ...
    public function __construct(
        ...
        $this->sameSite = static::createSameSiteEnum($sameSite ?? static::$defaults['samesite']);
    ...
    public static function setDefaults(array $options): void
    {
        ...
        if (isset($options['samesite'])) {
            $options['samesite'] = static::createSameSiteEnum($options['samesite']);
        }
    ...
    public static function createFromHeaderString(string $cookie, array $defaults = []): static
    {
        ...
        if (isset($data['samesite'])) {
            try {
                $data['samesite'] = static::createSameSiteEnum($data['samesite']);
            } catch (ValueError) {
                unset($data['samesite']);
            }
        }
    ...
    {
        $new = clone $this;
        $new->sameSite = static::createSameSiteEnum($sameSite);
     ...
     */
    protected static function createSameSiteEnum(SameSiteEnum|string|null $sameSite): ?SameSiteEnum
    {
        return match (true) {
